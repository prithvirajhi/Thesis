...
\blfootnote{*This  work is based upon paper titled "\aetherflow: Principled Wireless Support in SDN" published in CoolSDN '15 and the paper titled "\crossflow: A Cross-layer Architecture for SDR using SDN principles" published in IEEE NFV-SDN '15.}
...
\begin{figure}[t]
  ...
  \caption{A UML diagram of OpenFlow data model. Each box represents a data
