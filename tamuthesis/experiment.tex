...
\begin{figure}
\centering
\includegraphics[trim=1.25in 1.5in 2in 0.5in, clip, width=.5\textwidth]{figures/topology}
...
\begin{figure}
\centering
\includegraphics[width=.5\textwidth]{figures/duration}
...
%     \includegraphics[trim=1.5in 3in 1.6in 1.1in, clip,
%     width=\textwidth]{figures/phase1}
%     \caption{Before STA association}
%     \label{fig:phase1}
%   \end{subfigure}
%   \begin{subfigure}{0.5\textwidth}
%     \includegraphics[trim=1.5in 2.8in 1.3in 1.25in, clip,
%     width=\textwidth]{figures/phase2}
%     \caption{Before handoff prediction}
%     \label{fig:phase2}
%   \end{subfigure}
% 
%   \begin{subfigure}{0.5\textwidth}
%     \includegraphics[trim=1.5in 2.8in 1.3in 1.25in, clip,
%     width=\textwidth]{figures/phase3}
%     \caption{After handoff prediction} 
%     \label{fig:phase3}
%   \end{subfigure}
%   \begin{subfigure}{0.5\textwidth}
%     \includegraphics[trim=1.5in 2.8in 1.3in 1.25in, clip,
%     width=\textwidth]{figures/phase4}
%     \caption{After STA handoff}
%     \label{fig:phase4}
%   \end{subfigure}
%   \caption{The evolution of STA packet forwarding directions and flow tables.}
% \end{figure*}
...
\begin{figure}
\centering
\includegraphics[width=.5\textwidth]{figures/throughput}
\caption{Comparison of throughput for \aetherflow and the baseline configuration.} % The throughput of
...
\begin{figure}
\centering
\includegraphics[width=.5\textwidth]{figures/loss}
\caption{Comparison of packet loss rate for \aetherflow and the baseline configuration.} % The packet loss
